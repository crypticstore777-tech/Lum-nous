...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-egoOenEu.mjs");
...
var manifest = {
	"74e4bd1692b6eb8646ef14c88cce0deeb7ed40d51037424f8eed2c607e32a3fe": {
		...
		importer: () => import("./ai-TjHltZ4E.mjs")
	},
	...
	"d6154d4cdb8153a42d7ecb369a38d180534d13f28a0b5d8e9970539124a32bb2": {
		functionName: "askDirector_createServerFn_handler",
		importer: () => import("./ai-TjHltZ4E.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DJ-Skau_.mjs").then((n) => n.t),
